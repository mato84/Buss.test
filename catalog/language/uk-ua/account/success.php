...
// Text
$_['text_message']  = '<p>Вітання! Ваш обліковий запис успішно створено!</p> <p>Тепер Ви можете скористатися додатковими можливостями: проглядання історії замовлень, друк рахунку, зміна інформації вашого профілю та багато іншого.</p> <p>Якщо У Вас є якісь запитання щодо роботи партнерської програми пишіть їх на нашу електронну адресу.</p> <p>Підтвердження вислано на ваш e-mail. Якщо ви не отримали його на протязі однієї години, будь-ласка <a href="%s">повідомте нас</a>.</p>';
