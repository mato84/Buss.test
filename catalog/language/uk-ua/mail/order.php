...
$_['text_new_greeting']         = 'Ваше замовленняя отримано і буде оброблене найближчим часом.';
...
$_['text_new_instruction']      = 'Пасажир';
...
$_['text_category']             = 'Автобус: ';
$_['text_manufacturer']         = 'Перевізник: ';
$_['text_new_footer']           = 'Пишіть у відповідь на цей e-mail, якщо у Вас є якісь запитання.';
$_['text_update_subject']       = 'Бронювання підтверджено.';
$_['text_update_greeting']		= 'БРОНЮВАННЯ ПІДТВЕРДЖЕНО';
$_['text_update_order_detail']  = 'Деталі';
$_['text_update_order_id']      = 'Номер бронювання:';
$_['text_update_customer']  	= 'Пасажир:';
$_['text_update_instruction']  	= 'Інформація';
