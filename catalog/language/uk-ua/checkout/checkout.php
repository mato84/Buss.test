...
$_['text_checkout'] 	         	 = 'Бронювання квитка не зобов`язує Вас до його придбання. Скасувати бронювання можна в будь-який час, але не пізніше, ніж за 3 години до часу відправлення! Оплата здійснюється  водію, при посадці у автобус!';

// Column
$_['column_name']                    = 'Квиток';
$_['column_model']                   = 'Модель';
$_['column_quantity']                = 'Кількість пасажирів';
$_['column_price']                   = 'Ціна за пасажира';
...
$_['entry_viber']                	 = 'Viber';
$_['text_same']                	 	 = 'співпадає з телефоном';
...
$_['entry_passengers'] 	             = 'Пасажир';
$_['button_add'] 	             	 = 'Додати пасажира';
...
$_['error_telephone']                = 'Вкажіть вірний телефон';
...
$_['notice_only_one']                = 'Завершіть попереднє бронювання!';
