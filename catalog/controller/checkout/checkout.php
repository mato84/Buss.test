...
class ControllerCheckoutCheckout extends Controller {
    ...
    // Confirm controller
		...
		// if (!isset($this->session->data['shipping_method'])) {
					 $this->session->data['shipping_method']['title'] = 'Безкоштовна доставка';
		...
		// if (!isset($this->session->data['payment_method'])) {
			...
			$this->session->data['payment_method']['title'] = 'Оплата Готівкою';
      ...
      if(array_key_exists('order_data',$this->session->data)){
				$this->session->data['order_data'] = array();
			}
