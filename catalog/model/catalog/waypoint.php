...
class ModelCatalogProduct extends Model{
  public function getAllWaypointInProduct($productId){
     $this->db->query("SELECT w.waypoint_id, w.latitude, w.longitude FROM (SELECT * FROM" . DB_PREFIX ."waypoint_to_route  WHERE product_id = '" .(int)$productId."') as ro INNER JOIN  oc_way_point w ON ro.waypoint_id = w.waypoint_id");
     return $query->row;
  }
