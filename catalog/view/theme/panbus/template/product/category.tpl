            ...
            <div class="caption">
                ...
                <div class="description-group" itemprop="description">
                  <div class="form-group_margin">
                    <label class="control-label" for=""><?php echo $text_departure; echo $product['from_name']?></label>
                  ...
                  <div class="form-group_margin">
                    <label class="control-label" for=""><?php echo $text_arrival; echo $product['to_name']?></label>
                    <div class="form-group_bg">
