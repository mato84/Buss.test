...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		if (isset($this->request->get['token']) && isset($this->session->data['token']) && ($this->request->get['token'] == $this->session->data['token'])) {
			...
			if ($this->user->hasPermission('access', 'catalog/city')) {
				$catalog[] = array(
					'name'	   => $this->language->get('text_city'),
					'href'     => $this->url->link('catalog/city', 'token=' . $this->session->data['token'], true),
					'children' => array()
				);
			}
            ...
            if ($this->user->hasPermission('access', 'catalog/passenger')) {
                $catalog[] = array(
                    'name'	   => $this->language->get('text_passenger'),
                    'href'     => $this->url->link('catalog/passenger', 'token=' . $this->session->data['token'], true),
                    'children' => array()
                );
            }
